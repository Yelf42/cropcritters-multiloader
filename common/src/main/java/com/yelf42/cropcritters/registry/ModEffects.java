...
public class ModEffects {
    ...
    public static final MobEffect SPORES = register("spores_effect", new SporesEffect(MobEffectCategory.NEUTRAL, 5882118));
    public static final Supplier<MobEffectInstance> NATURAL_SPORES = () -> new MobEffectInstance(SPORES, 6000, 0, true, true, false);

    public static final MobEffect PUFFBOMB_POISONING = register("puffbomb_poisoning", new PuffbombPoisoningEffect(MobEffectCategory.HARMFUL, 16770790));
    ...
    public static final MobEffect SOUL_SIPHON = register("soul_siphon", new SoulSiphonEffect(MobEffectCategory.HARMFUL, 7561558));
